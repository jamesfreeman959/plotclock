...
//#define CALIBRATION 1     // enable calibration mode
...
// On aliexpress board, servos are oriented looking at clock with servos at bottom (i.e. left servo is furthest from park position (pen holder)
// Later on in the code, "O1" refers to LEFT and "O2" to right.
...
// Set the I/O pins used to control the servos
#define SERVOPINLIFT  2
#define SERVOPINLEFT  3
#define SERVOPINRIGHT 4

// lift positions of lifting servo
// On aliexpress kit, bigger numbers move pen towards writing surface
// In calibration mode, board operates at LIFT0 only
// 
// These units are specified in micoseconds, where ~1000us = 0^ and 2000us = 180^
//#define LIFT0 1080 // on drawing surface
//#define LIFT1 925  // between numbers
//#define LIFT2 725  // going towards sweeper
#define LIFT0 1680  // on drawing surface
...
// length of arms - from pivot point to pivot point (or pen center) in mm
// L1 from servo to mid pivot
#define L1 35
// L2 from mid pivot to pen holder extension
#define L2 57.1
// L3 length of small pen holder extension
#define L3 13.2
...
// PEN holder position in mm from origin
#define PARKX 73
#define PARKY 46 
// Width of erase "arc"
#define ERASEMAXX 58
